...
//Variables
//###################
// Data type : int, double, string, boolen 
// Variable
...
Console.WriteLine("The Loop is finished, because > 10");
...
for (int i = 0; i < 100; ++i)
{
    if (i > 10)
    {
        break;// Stop if more than 10
    }
    Console.WriteLine("The break Loop run " + i);
}
...
for (int i = 0; i <= 10; i++)
{
    ...
    Console.WriteLine(i);// Output: 1,2,4,5,7,8,10 
}
...
//Arrays
//###################
// set a new array with 3 intergent
int number_array = new int[3]; // {0, 0 ,0}
number_array[0]= 1;
number_array[1]= 2;
number_array[2]= 3;

// set a new array with 5 inttergent 1, 2, 4, 7, 2
...
// list length
Console.WriteLine(someWords.Count);// 2
// add new item(s)
someWords.Add("three");
...
Console.WriteLine("the count of list is "+someWords.Count);// 2
 ...
 list.Remove(4);
 Console.WriteLine("the first of the list is : "+list[0]);
 Console.WriteLine("The new list : "+list);
 Console.WriteLine("the count of list is "+list.Count);
foreach (var num in list){
    Console.WriteLine("the num in list are : "+num);
}
